...
def get_product_price(product: str) -> float:
    ...
    prices = {"laptop": 1299.99, "headphones": 149.95, "keyboard": 89.50, "Lenovo Thinkpad T14": 1200}
...
if __name__ == "__main__":
    ...
    print()
    result = run_agent("What is the price of a laptop Lenovo Thinkpad T14 after applying a gold discount?")